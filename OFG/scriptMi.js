...
Зачем-же два файла со скриптом на JS? Ответ простой: так у меня будет файл с основным тестируемым кодом, и если придется переписывать, я всегда смогу вернутся к изначальному файлу.*/
